...
class IdNewHolder(BaseDriver):
    ...
    def add_holder_profile(self, fname, fathername, gfname):
        add_holder = self.driver.find_element(By.ID, "gift_harmony_beneficiary_add")
    ...
    def add_party(self, fname, fathername, gfname,  address, uploadid, idreference, pomdoc,add_pom_ref):
