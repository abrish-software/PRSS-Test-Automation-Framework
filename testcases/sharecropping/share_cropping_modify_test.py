...
from pages.sharecropping.sharecropping_modify_officer import ShareCroppingModifyOfficer
...
@ddt
class Test_Share_Cropping_Modification(unittest.TestCase):
    ...
    def Class_Setup(self):
        ...
        self.officer = ShareCroppingModifyOfficer(self.driver)
    ...
    @file_data('../../testdata/sharecropping/sharecroppingmodificationtestdata.yaml')
    def test_register_modify_share_cropping_transaction(self, shcapplicationdescription, firstname, fathername,
        ...
        self.officer.register_modify_share_cropping_transaction(shcapplicationdescription, firstname, fathername,
                                                                gfname, idfile, idtext, pomfile,
                                                                pomreference, pomdescription, agreementdoc,
                                                                shcreference, shcdescription, uploadLHC,
                                                                addLHCreference, addLHCdescription)
