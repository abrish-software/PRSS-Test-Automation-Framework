...
from pages.sharecropping.sharecropping_reg_officer import ShareCroppRegOfficer
...
@ddt
class Test_Share_Cropping_Registration(unittest.TestCase):
    ...
    def Class_Setup(self):
        ...
        self.officer = ShareCroppRegOfficer(self.driver)
    ...
    @file_data('../../testdata/sharecropping/sharecroppingdata.yaml')
    def test_register_share_cropping_transaction(self, shapplicationdescription, firstname, fathername,
                                       gfname, idfile, idtext, pomfile,
                                       pomreference, pomdescription,
                                       shfname, shfathername, shgfname, shcaddress,
        ...
        self.officer.register_share_cropping_transaction(shapplicationdescription, firstname, fathername,
                                       gfname, idfile, idtext, pomfile,
                                       pomreference, pomdescription,
                                       shfname, shfathername, shgfname, shcaddress,
                                       uploadid, idreference,agreementdoc,
