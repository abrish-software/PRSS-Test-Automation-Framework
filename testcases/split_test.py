...
from pages.Split.close_split import CloseSplit
from pages.Split.split_officer import SplitOfficer
...
class Test_Split(unittest.TestCase):
    ...
    def Class_Setup(self):
        ...
        self.officer = SplitOfficer(self.driver)
        self.expert = Expert(self.driver)
        self.close = CloseSplit(self.driver)
        self.supervisor = Supervisor(self.driver)

    # @file_data("../testdata/testdata.json")
    @file_data('../testdata/split/splittestdata.yaml')
    def test_register_split_transaction(self, sapplicationdescription, firstname, fhidfile, fhidtext,
        ...
        self.officer.register_split_transaction(sapplicationdescription, firstname, fhidfile, fhidtext,
                                                shidfile, shidtext, uploadLHC, addLHCreference, addLHCdescription)
