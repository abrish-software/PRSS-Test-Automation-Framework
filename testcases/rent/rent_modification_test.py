...
@ddt
class Test_Rent_Modification(unittest.TestCase):
    ...
    @file_data('../../testdata/rent/rentmodificationtestdata.yaml')
    def test_register_modify_rent_transaction(self, rmapplicationdescription, firstname, fathername,
        ...
        self.modifyOfficer.register_modify_rent_transaction(rmapplicationdescription, firstname, fathername,
                                                            gfname, idfile, idtext, pomfile,
                                                            pomreference, pomdescription, rentvalue, agreementdoc,
                                                            rentreference, rentdescription, uploadLHC,
                                                            addLHCreference, addLHCdescription)
