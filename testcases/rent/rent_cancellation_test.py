...
@ddt
class Test_Rent_Cancellation(unittest.TestCase):
    ...
    def Class_Setup(self):
        ...
        self.officer = RentCancelOfficer(self.driver)
        self.expert = ExpertNoCMSS(self.driver)
        self.close = CloseTheTransaction(self.driver)
        self.supervisor = Supervisor(self.driver)

    @file_data('../../testdata/rent/rentcancellationtestdata.yaml')
    def test_register_cancel_rent_transaction(self, rcapplicationdescription, firstname, fathername,
        ...
        self.officer.register_cancel_rent_transaction(rcapplicationdescription, firstname, fathername,
                                                      gfname, idfile, idtext, pomfile,
                                                      pomreference, pomdescription, uploadRCD,
                                                      addRCDreference, addRCDdescription, uploadLHC,
                                                      addLHCreference, addLHCdescription)
