...
@ddt
class Test_InheritWithWill(unittest.TestCase):
    ...
    def Class_Setup(self):
        ...
        self.officer = InheritWithWillOfficer(self.driver)
    ...
    @file_data('../testdata/inheritancewithwill/inheritancewithwilltestdata.yaml')
    def test_register_inheritwithwill_transaction(self, inheritwithwillapplicationdescription, dfirstname, dfathername,
        ...
        self.officer.register_inheitwithwill_transaction(inheritwithwillapplicationdescription, dfirstname, dfathername,
                                            dgfname , fname, fathername, gfname, address, uploadid, idreference, pomdoc,
                                            add_pom_ref, POD, podreference, poddescription, cr, crreference, crdescription
                                            , willdoc, willreference, willdescription, LHC, LHCreference, LHCdescription)
