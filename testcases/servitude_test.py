...
@ddt
class Test_Servitude(unittest.TestCase):
    ...
    def Class_Setup(self):
        ...
        self.officer = ServitudeOfficer(self.driver)
    ...
    @file_data('../testdata/servitude/servitudetestdata.yaml')
    def test_register_servitude_transaction(self,sapplicationdescription,firstname, fathername,
        ...
        self.officer.register_servitude_transaction(sapplicationdescription,firstname, fathername,
                                       gfname,idfile, idtext,pomfile,
                                       pomreference, pomdescription,pfname,
                                       pfathername, pgfname, address,
                                       uploadid, idreference,uploadLHC,
