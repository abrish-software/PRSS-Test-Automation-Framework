...
from pages.mortgage.clearance import ClearanceOfficer
...
@ddt
class Test_Clearance(unittest.TestCase):
    ...
    def Class_Setup(self):
        ...
        self.officer = ClearanceOfficer(self.driver)
    ...
    @file_data('../../testdata/mortgage/clearancetestdata.yaml')
    def test_clearance(self, capplicationdescription, firstname, fathername,
        ...
        self.officer.register_clearance(capplicationdescription, firstname, fathername,
                                        gfname, idfile, idtext, pomfile, pomreference, pomdescription,
                                        fname, fphone, faddress, fdesc, uploadLHC, LHCreference, LHCdescription)
