...
class ShareCroppingModifyOfficer(BaseDriver):
    ...
    def modify_share_cropping(self):
        click_modify_share_cropping = self.driver.find_element(By.XPATH, "//a[@class='btn btn-sm btn-nrlais' and "
                                                                         "contains(text(), 'Modify S-Cropping')]")

        self.driver.execute_script("arguments[0].scrollIntoView(true);", click_modify_share_cropping)
        time.sleep(5)
        self.driver.execute_script("arguments[0].click();", click_modify_share_cropping)
        time.sleep(10)

    def share_cropping_modify_application_description(self, shcapplicationdescription):
    ...
    def share_cropping_end_date(self):
        ...
        self.driver.execute_script("arguments[0].selectedIndex = arguments[0].selectedIndex + 2;", select_year)
        time.sleep(5)
    ...
    def register_modify_share_cropping_transaction(self, shcapplicationdescription, firstname, fathername,
                                         gfname, idfile, idtext, pomfile,
                                         pomreference, pomdescription,agreementdoc,
        ...
        self.modify_share_cropping()
        self.share_cropping_modify_application_description(shcapplicationdescription)
        self.next_to_second()
