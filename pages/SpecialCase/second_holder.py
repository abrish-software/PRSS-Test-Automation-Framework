...
class SecondHolder(BaseDriver):
    ...
    def add_second_holder_info(self, fname, fathername, gfname):
    ...
    def register_second_holder_Information(self, sfirstname, sfathername, sgfname, shaddress, sshareinfo, suploadid,
                                           sidreference):
        # self.select_special_case()
        # self.select_kebele()
        # self.application_description(appdescription)
        self.add_second_holder_info(sfirstname, sfathername, sgfname)
        self.select_gender()
        self.add_DOB()
        self.marital_status()
        self.holder_address(shaddress)
        self.disability_info()
        self.family_status()
        self.share_information(sshareinfo)
        self.Id_Information(suploadid, sidreference)
