...
class InheritWithoutWillOfficer(BaseDriver):
    ...
    def select_inheritwithoutwill_transaction(self):
        ...
        time.sleep(5)
        inheritwithoutwill_transaction = self.driver.find_element(By.XPATH, '//*[@id="inheritance_popover"]/ul/li[2]/a')
        self.driver.execute_script("arguments[0].click();", inheritwithoutwill_transaction)
        time.sleep(5)

    def inheritwithoutwill_application_description(self, inheritwithoutwillapplicationdescription):
        self.appdesc.application_description(inheritwithoutwillapplicationdescription)

    def load_inheritwithoutwill_parcel(self, dfirstname, dfathername, dgfname):
    ...
    def add_court_decision(self, cddoc, cdreference, cddescription):
        add_court = self.driver.find_element(By.XPATH, '//*[@id="row_3"]/td[5]/a')
        self.driver.execute_script("arguments[0].click();", add_court)
        time.sleep(5)
        upload_court = self.driver.find_element(By.ID, "upload_doc_req")
        upload_court.send_keys(cddoc)
        time.sleep(5)
        court_reference = self.driver.find_element(By.ID, "doc_reference_req")
        court_reference.send_keys(cdreference)
        time.sleep(5)
        court_description = self.driver.find_element(By.ID, "doc_description_req")
        court_description.send_keys(cddescription)
        time.sleep(5)
        save_court = self.driver.find_element(By.XPATH, '//*[@id="add_req_document"]/div/div/div[3]/div/button')
        self.driver.execute_script("arguments[0].click();", save_court)
        time.sleep(5)
    ...
    def register_inheitwithoutwill_transaction(self, inheritwithoutwillapplicationdescription, dfirstname, dfathername,
        ...
        self.select_inheritwithoutwill_transaction()
        self.inheritwithoutwill_application_description(inheritwithoutwillapplicationdescription)
        self.load_inheritwithoutwill_parcel(dfirstname, dfathername,dgfname)
        ...
        self.add_court_decision(cddoc, cdreference, cddescription)
