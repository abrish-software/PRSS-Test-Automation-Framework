...
class RentRegOfficer(BaseDriver):
    ...
    def select_rent_transaction(self):
        time.sleep(5)
        rent_transaction = self.driver.find_element(By.XPATH, "//p[normalize-space()='Rent/Lease']")
        self.driver.execute_script("arguments[0].click();", rent_transaction)
        time.sleep(5)

    def rent_application_description(self, rapplicationdescription):
        self.appdesc.application_description(rapplicationdescription)
    ...
    def register_rent_transaction(self, rapplicationdescription, firstname, fathername,
        ...
        self.select_rent_transaction()
        self.rent_application_description(rapplicationdescription)
        ...
        self.assign_parcel()
        self.next_to_fourth()
        self.add_tenant(tfname, tfathername, tgfname, taddress, uploadid, idreference)
        self.next_to_fifth()
